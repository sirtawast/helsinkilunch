const restaurants = {
  pitajanmaki: [
    {
      ...
      slug: "kanttiini",
      content: ".so-panel.widget.widget_sow-features | sanitize",
      selector: 'body'
    },
    {
      url:
    ...
    },
    {
      ...
      slug: "factory",
      content: ".post_content .col-xs-12 | sanitize",
      selector: 'body'
    },
    {
      url:
  ...
  helsinki: [
    ...
    },
    {
      ...
      slug: "latorrefazione",
      selector: 'body',
      content: "#lounas | sanitize"
    },
    {
      url: "http://www.ravintolakarljohan.fi/lounas/",
      slug: "karljohan",
      selector: 'body',
      content: ".menu-wrap | sanitize"
    },
    {
    ...
    },
    {
      ...
      slug: "lonkka",
      selector: 'body',
      content: ".food-columns:nth-of-type(2) | sanitize"
    }
  ],
  vallila: [
    {
